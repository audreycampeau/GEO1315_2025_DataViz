...
Le lacs Pin rouge fut le lacs ayant les plus haut flux de CO~2~ envers l’atmosphère, alors que le lac Echo était le seul agissant comme un puit net de CO2 envers l'atmosphère. Tout les deux sont des lacs classé "mésotrophe", comme nous avons vu dans la section 6, ce qui peut contribuer a augmenter la variabilité des flux de CO~2~ (tant positivement que négativement).
